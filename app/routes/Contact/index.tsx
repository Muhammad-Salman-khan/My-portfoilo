...
const index = () => {
  return (
    <>
      <div className="min-h-screen bg-slate-950 grid grid-cols-1 ">
        ...
        >
          ...
          />
          <motion.div
            className="relative z-10 flex flex-col items-center justify-center h-full p-12 text-white"
              ...
              <div className="relative">
                ...
                <div className="relative flex items-end gap-x-2 p-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      <a
                        href="https://www.linkedin.com/in/salman-khan-dev/"
                        target="_blank"
                      >
                        <svg
                          viewBox="0 0 24 24"
